  ...
  <div id="image-track2" data-mouse-down-at="0" data-prev-percentage="0">
    ...
    <div id="troix">
      <div class="left">
        ...
        <span>y</span>
        <p>
          Currently in my second year of computer science studies, I am particularly interested in front-end development,
      ...
      <div class="right">
        <p>
          I've always loved creating things, from videos to cartoons. I like to use my imagination to give flesh to my
        ...
        <span>y</span>
        <p>
          I work with Vue.js and use Anime.js for animation and Three.js for WEBGL. I am accustomed to using WordPress,
          whether it's headless or not. My personal projects and studies have led me to use a variety of technologies,
    ...
    <div id="quatre">
      ...
      <div class="left2">
        ...
        <p class="end2"> If you want to stay updated on my latest adventures:</p>

        <div class="res">
          <a class="reseaux" href="https://www.linkedin.com/in/baptiste-audeon-04b070287/">Linkedin</a>
          <!-- <a class="reseaux" href="">Twitter</a>
          <a class="reseaux" href="">Behance</a> -->
        </div>
      ...
      <div class="right2">
        <div class="merci">
          <span class="ty">M</span>
          <span class="ty">e</span>
          <span class="ty">r</span>
          <span class="ty">c</span>
          <span class="ty">i</span>
          <span class="ty"></span>

        </div>
        <p class="end1">
          Available for freelance work, Would you like to discuss a new project?
        </p>
        <a href="mailto:bapt.audeon@gmail.com">
          <img src="/src/assets/img/e-mail.png" alt="" class="mail" draggable="false">
        </a>
        <p class="by">Designed by Baptiste Audeon.</p>
      </div>
      ...
      <img class="laposte" src="/src/assets/img/image2.png" alt="" draggable="false">
    </div>
...
onBeforeUnmount(() => {
  ...
  window.removeEventListener("wheel", (event) => {
    const direction2 = event.deltaY > 0 ? 5 : -5;
    handleScroll2(direction2);
  });
