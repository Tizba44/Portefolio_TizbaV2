<template>
    ...
    <main :style="mainStyle">
        ...
        <div class="container" v-if="showo">
            ...
            <div class="left">
                <h2>Amalgames: a fashion blog</h2>
                <p>
                    My friend has lost his job as an editor for one of the largest French blogs.
                </p>
                <p>
                    Together, we decided to launch our own fashion blog. Here is the Wordpress theme design i created for
                    that four hands project.
                    It has a dark and light mode. Moreover, it's a multilingual site with versions in French and
                    English.
                </p>
                <p>
                    Although unsatisfied with the design, i'm prouf of showing this first project.
                </p>
                <p class="stop">(We stopped, I migrated the blog to my portfolio.)
                </p>
            </div>
            ...
            <div class="right">
                ...
                <h3>Client:</h3>
                <p> Sylvain Garel / personal project.</p>

                <a class="see" href="https://amalgames.baptisteaudeon.com/" target="_blank">see website</a>
...
import projet1 from '/src/assets/img/projet1.png'
